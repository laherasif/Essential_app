			...
			columns: [
				{
					...
					template: function(row) {
						...
						return '<span class="label font-weight-bold label-lg label-' + status[row.Type].state + ' label-dot me-2"></span><span class="font-weight-bold text-' + status[row.Type].state + '">' +

    ...
    var options = {
        ...
        columns: [{
            ...
            template: function(row) {
                ...
                return '<span class="label label-' + status[row.Type].state + ' label-dot me-2"></span><span class="font-weight-bold text-' + status[row.Type].state + '">' + status[row.Type].title + '</span>';
            },
        }, {
            field: 'Actions',
            title: 'Actions',

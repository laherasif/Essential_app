			...
			columns: [
				{
					...
					template: function(row) {
						...
						return '<span class="label label-' + status[row.Type].state + ' label-dot me-2"></span><span class="font-weight-bold text-' + status[row.Type].state +
							'">' +
					...
					template: function() {
						return '\
	                        <div class="dropdown dropdown-inline">\
	                            <a href="javascript:;" class="btn btn-sm btn-clean btn-icon me-2" data-toggle="dropdown">\
	                        ...
	                        <a href="javascript:;" class="btn btn-sm btn-clean btn-icon me-2" title="Edit details">\
	                            <span class="svg-icon svg-icon-md">\
	                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
	                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
	                                        <rect x="0" y="0" width="24" height="24"/>\
				...
				columns: [
					{
						...
						template: function(row) {
							...
							return '<span class="label label-' + status[row.Type].state + ' label-dot me-2"></span><span class="font-weight-bold text-' +

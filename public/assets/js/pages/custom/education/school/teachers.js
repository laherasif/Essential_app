					...
					template: function() {
						return '\
	                        <div class="dropdown dropdown-inline">\
	                            <a href="javascript:;" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon me-2" data-toggle="dropdown">\
	                        ...
	                        <a href="javascript:;" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon me-2" title="Edit details">\
	                            <span class="svg-icon svg-icon-md">\
